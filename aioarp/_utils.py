...
class LocalNetwork:
    def get_mac(self, interface: typing.Optional[str] = None) -> str:  # pragma: no cover
    ...
    def get_ip(self, ) -> str:  # pragma: no cover
        global OUR_IP
        if OUR_IP:
            return OUR_IP
    ...
    def get_default_interface(self, ) -> str:  # pragma: no cover
